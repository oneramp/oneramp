...
async function run() {
  ...
  console.log("Alfajores Relayer ID: ", relayer.relayerId)
  ...
  appendFileSync(
    ".env",
    `\nCELO_ALFAJORES_RELAYER_API_KEY=${relayerKey}\nCELO_ALFAJORES_RELAYER_API_SECRET=${relayerSecret}\n Alfajores_Relayer_ID = ${relayer.relayerId}`
  )
}
